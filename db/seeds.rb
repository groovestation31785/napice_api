...
ExpandedTextAd.create(xsi_type: "ExpandedTextAd", ad_group_id: ad_group1.id, headline_part1: "Developers from Mars", description: "Buy your tickets now!", path1: "all-inclusive", path2: "deals")
ExpandedTextAd.create(xsi_type: "ExpandedTextAd", ad_group_id: ad_group3.id, headline_part1: "We are looking for the best designers", headline_part2: "Best in the galaxy", description: "We are a team of product builders and are looking for designers", path1: "all-inclusive", path2: "deals")
