...
RSpec.describe ExpandedTestAdsController, type: :controller do

  # This should return the minimal set of attributes required to create a valid
  # ExpandedTestAd. As you add validations to ExpandedTestAd, be sure to
  ...
  # ExpandedTestAdsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
